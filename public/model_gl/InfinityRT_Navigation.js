...
var infinityrt_navigation = function (scene, w, h) {
    ...
    this._navMode = 2;
    this._navMinDolly = 17.0; //50
    this._navMaxDolly = 38.0; //110
    ...
    this._dollyCorrectionFactor = 23;
   ...
   // this._navMode2Speed = 0.03;     // Navigation speed
    ...
    this._panMax = [16, 16];    //[left, bottom];
    this._panMin = [-16, -16];  //[right, top];
...
infinityrt_navigation.prototype.ApplyRestrictionAdjust = function (fovadjust) {
    ...
    if (adir > fovadjust) {
        ...
        var tan1 = Math.tan(ofov * 0.5 * (Math.PI / 180.0));
        var tan2 = Math.tan(this._scene.fovy * 0.5 * (Math.PI / 180.0));
  
        this._navDolly -= this._dollyCorrectionFactor;
        this._navDolly = (tan1*this._navDolly) / tan2;
        this._navDolly += this._dollyCorrectionFactor;
    }
        ...
        if(delta === undefined && sliderValue !== undefined){
           ...
           // console.log(delta);      
            if(sliderValue !== undefined)
                ...
                this._navDDolly -= delta * this._navDollySpeed*(1.0-this._navDecay)*(this._navMaxDolly-this._navMinDolly);
        }
